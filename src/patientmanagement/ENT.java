...
public class ENT extends Doctor {
     public ENT(String docName, String dept,  boolean isSurgeon, boolean isOnDuty) {
        this.name = docName;
...
//    public ENT(String docName, String dept, boolean isSurgeon, boolean isOnDuty) {
//    super( docName, dept, "ENT", isSurgeon, isOnDuty, true, true, false, false);
//    }
